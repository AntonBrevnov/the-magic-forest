...
namespace build_alpha_0._2.Core.WorldLibrary
{
    public class Tree : Healthable
    {
        ...
        public Tree(Animation animation) : base()
        {
            sprite = new Sprite();
            shape = new RectangleShape();
        ...
        public Tree(int maxHP, int maxHG, int maxDP) : base(maxHP, maxHG, maxDP)
        {
            sprite = new Sprite();
            shape = new RectangleShape();
            animation = new Animation();
        ...
        public Tree(int maxHP, int maxHG, int maxDP, Animation animation) : base(maxHP, maxHG, maxDP)
        {
            sprite = new Sprite();
            shape = new RectangleShape();
            this.animation = animation;
